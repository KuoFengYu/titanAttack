...
<head>
    ...
    <link rel=stylesheet type="text/css" href="css/翻牌GAME result.css">
...
<body>
    <div class="row">
        ...
        <div class="container my-2 text-center">
            <div id="content"></div>
            <p class="text-center text-white">排行榜 (困難)</p>
            <?php
            $result = mysqli_query($link, "select Name,Time, updatetime from `playerlist` order by Id DESC LIMIT 1");
            ...
            <table class="table table-striped table-light">
                ...
                <tbody>
                    <?php $i = 1;
                    $result2 = mysqli_query($link, "select Name,Time, updatetime from `playerlist` order by CHAR_LENGTH(Time) asc,Time,Id limit 0,10");
    ...
    <script>
        ...
        var item = '<img id="winPic" src="img/gameresult/winner2.jpg">'
