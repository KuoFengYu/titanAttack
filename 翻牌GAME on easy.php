...
<head>
    ...
    <link rel=stylesheet type="text/css" href="css/翻牌GAME on easy.css">
...
<body>
    <div class="row">
        ...
        <!-- post data -->
        <form class="text-center" id="nickName" method="post" action="timerResult2.php">
            <div class="m-auto">
                <input type="hidden" id="mytimer" name="mytimerEasy" type="text" value="">
                請輸入暱稱: <br> <input type="text" name="nameEasy">
        ...
        <!-- gameArea -->
        <section class="col-5 cardGame mx-auto my-3">
            <!-- card area--12 cards-->
            <div class="myCard" data-cardName="No1">
                <img class="frontSide" src="img/角色/card1.png">
                <img class="backSide" src="img/卡牌/卡牌封面6.jpg">
            </div>
            <div class="myCard" data-cardName="No1">
                <img class="frontSide" src="img/角色/card1.png">
                <img class="backSide" src="img/卡牌/卡牌封面6.jpg">
            </div>
            <div class="myCard" data-cardName="No2">
                <img class="frontSide" src="img/角色/card2.jpg">
                <img class="backSide" src="img/卡牌/卡牌封面6.jpg">
            </div>
            <div class="myCard" data-cardName="No2">
                <img class="frontSide" src="img/角色/card2.jpg">
            ...
            <div class="myCard" data-cardName="No3">
                <img class="frontSide" src="img/角色/card3.jpg">
                <img class="backSide" src="img/卡牌/卡牌封面6.jpg">
            </div>
            <div class="myCard" data-cardName="No3">
                <img class="frontSide" src="img/角色/card3.jpg">
    ...
    <script>
        ...
        function flipCard() {
            ...
            if (count == 3) {
                ...
                // document.location = '翻牌GAME result.php';
                // document.location = 'timerResult.php';
